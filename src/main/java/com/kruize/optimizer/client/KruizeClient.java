...
public interface KruizeClient {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    List<KruizeProfile> getMetadataProfiles(@jakarta.ws.rs.QueryParam(OptimizerConstants.KruizeClientConstants.VERBOSE) boolean verbose);
    ...
    @Path(OptimizerConstants.KruizeClientConstants.LIST_METRIC_PROFILE_ENDPOINT)
    @Produces(MediaType.APPLICATION_JSON)
    List<KruizeProfile> getMetricProfiles(@jakarta.ws.rs.QueryParam(OptimizerConstants.KruizeClientConstants.VERBOSE) boolean verbose);
    ...
    @Path(OptimizerConstants.KruizeClientConstants.BULK_ENDPOINT)
    @Produces(MediaType.APPLICATION_JSON)
    String getBulkJobStatus(@jakarta.ws.rs.QueryParam(OptimizerConstants.KruizeClientConstants.JOB_ID) String jobId);
}
