...
/**
 * REST resource for metadata profile operations
 */
@Path(OptimizerApiConstants.KRUIZE_BASE_PATH + OptimizerApiConstants.METADATA_PROFILES_PATH)
public class MetadataProfileResource {

    private static final Logger LOG = Logger.getLogger(MetadataProfileResource.class);
     ...
     * POST /kruize/metadataProfiles/install
     *
